...
def use_docker(module):
    ...
    try:
        ...
        module.fail_json(msg="Can not parse the inner module output: %s" % json_output)
    ...
    try:
        ...
        module.fail_json(msg="Ansible JSON output has unexpected format: %s" % output)
...
def use_podman(module):
    ...
    try:
        ...
        _, raw_output = kolla_toolbox.exec_run(
            command_line, environment=environment, tty=True, **kwargs
        )
